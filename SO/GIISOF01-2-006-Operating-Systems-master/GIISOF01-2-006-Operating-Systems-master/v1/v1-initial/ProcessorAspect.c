...
case 'o': ComputerSystem_DebugMessage(3, 'h', operationCode, operand1, operand2, registerPC_CPU, registerAccumulator_CPU, registerPSW_CPU, Processor_ShowPSW()); 
