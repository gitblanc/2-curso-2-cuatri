...
typedef struct {int busy; int initialPhysicalAddress; int processSize; int state; int priority; int copyOfPCRegister; unsigned int copyOfPSWRegister; int copyOfAccumulator; int programListIndex; int queueID; 
}PCB; 
...
# 1572 "OperatingSystemAspect.c"

}

# 1576 "OperatingSystemAspect.c"
...
case (-3): ComputerSystem_DebugMessage(103, 'e', (programList[i]->executableName)); 
#line 143 "OperatingSystem.c"
break; 
#line 144 "OperatingSystem.c"
case (-1): ComputerSystem_DebugMessage(104, 'e', (programList[i]->executableName), "it does not exists"); 
#line 146 "OperatingSystem.c"
break; 
#line 147 "OperatingSystem.c"
case (-2): ComputerSystem_DebugMessage(104, 'e', (programList[i]->executableName), "invalid priority or size"); 
#line 149 "OperatingSystem.c"
break; 
#line 150 "OperatingSystem.c"
case (-4): ComputerSystem_DebugMessage(105, 'e', (programList[i]->executableName)); 
...
case SYSCALL_PRINTEXECPID: ComputerSystem_DebugMessage(24, 'p', executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName)); 
#line 416 "OperatingSystem.c"
break; 
#line 418 "OperatingSystem.c"
case SYSCALL_END: ComputerSystem_DebugMessage(25, 'p', executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName)); 
