...
default: ComputerSystem_DebugMessage(141, 'i', executingProcessID, (programList[processTable[executingProcessID].programListIndex]->executableName), systemCallID); 
#line 532 "OperatingSystem.c"
OperatingSystem_TerminateProcess(); 
#line 533 "OperatingSystem.c"
break; } } 
# 2383 "OperatingSystemAspect.c"
