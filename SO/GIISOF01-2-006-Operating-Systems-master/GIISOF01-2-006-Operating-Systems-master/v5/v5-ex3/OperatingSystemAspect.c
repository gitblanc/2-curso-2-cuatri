...
# 890 "OperatingSystemAspect.c"
{
# 892 "OperatingSystemAspect.c"
...
# 903 "OperatingSystemAspect.c"
retValue_acc = __builtin_bswap64(__bsx);
# 905 "OperatingSystemAspect.c"
...
int OperatingSystem_checkIfShutdown()  
# 3074 "OperatingSystemAspect.c"
{
# 3076 "OperatingSystemAspect.c"
int retValue_acc;
