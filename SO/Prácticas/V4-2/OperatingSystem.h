...
#define MEMCONFIG // Ej 5 V4 

#define MEMORYFULL -5 //Ej 6 V4

//EX5-V2-inicio
#define NUMBEROFQUEUES 3
enum TypeOfReadyToRunProcessQueues { USERPROCESSQUEUE, DAEMONSQUEUE, WAKEUPQUEUE};
//EX5-V2-final
...
enum SystemCallIdentifiers { SYSCALL_END=3, SYSCALL_PRINTEXECPID=5, SYSCALL_YIELD=4, SYSCALL_SLEEP=7};//EX12-v1
