...
public class Imagen {
	 ...
	 */
	public void addSignal(Imagen img) {//suma dos imágenes
		for (int i = 0; i < width; i++)
	        for (int j = 0; j < height; j++)
	 ...
	 */
	public void suppressRegion(int region) {//borra una parte de la imagen, añade distorsión a la imagen
		//suppression loop
		switch (region) {
	 ...
	 * @return
	 */
	public float zncc(Imagen img) {//implementa la correelación cruzada
		float cc = 0;
		float std_i = 0;
